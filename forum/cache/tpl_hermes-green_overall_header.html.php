...
<tr>
	...
	<tr>
	    <td id="logo-left" valign="top"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/logo_left_top.gif" width="80" height="66" border="0" alt="" /></td>
	    <td id="logo-mid" valign="middle"><a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>"><?php echo (isset($this->_rootref['SITE_LOGO_IMG'])) ? $this->_rootref['SITE_LOGO_IMG'] : ''; ?></a></td>
	    <td id="logo-right" valign="top"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/logo_right_top.gif" width="80" height="66" border="0" alt="" /></td>
    </tr>		    
	</table></div></div></td>
</tr>
<tr>
...
<tr>
	...
	<tr>
	    <td id="content-left" valign="top"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/content_top_left.gif" width="5" height="5" border="0" alt="" /></td>
