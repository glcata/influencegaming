...
(function() {
  ...
  var fourSpaces = function(tabSize) {
	var spaces = [];
	
	for (i = 0, l = tabSize; i<l; i++) spaces.push("\u00a0");
window.w00fz = spaces;
	return spaces.join("");
  };
  ...
  if (select.ie_selection) {
    ...
    select.insertTabAtCursor = function(window, tabSize) {
	  var nbsp = "";
      for (i = 0, l = tabSize; i<l; i++) nbsp += " ";
      insertAtCursor(window, "\xa0\xa0");
    };
  ...
  // W3C model
    ...
    select.insertTabAtCursor = function(window, tabSize) {
	  var nbsp = "";
      for (i = 0, l = tabSize; i<l; i++) nbsp = nbsp + "\xa0";
      insertNodeAtCursor(window, window.document.createTextNode(nbsp));
    };
