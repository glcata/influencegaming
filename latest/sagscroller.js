...
var sagscroller_constants={
	navpanel: {height:'16px', downarrow:'latest/down.gif', opacity:0.6, title:'Go to Next Content', background:'black'},
	loadingimg: {src:'latest/ajaxloading.gif', dimensions:[100,15]}
}
